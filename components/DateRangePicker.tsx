  ...
  return (
    <div className="flex flex-col items-start gap-2 lg:items-end">
      <div className="flex flex-wrap items-center gap-3 text-[13px]">
        ...
        <select id="date-range" value={customOpen ? "custom" : String(value.days)} onChange={(event) => selectRange(event.target.value)} className="rounded border border-rule bg-white px-2.5 py-1.5 text-[13px] outline-none focus:border-accent focus:ring-2 focus:ring-accent/15">
      ...
      {customOpen && <div className="flex flex-wrap items-end gap-2 rounded border border-rule bg-white p-2.5 text-xs shadow-sm">
